...
import herophoto from '../images/Component 1.png';
import AboutPage from './about';
import Footer from './foothero';
...
const LandingPage: React.FC = () => {
  ...
  const handleContactMe = () => {
    window.open('mailto:amitkgupta2308@gmail.com'); // Replace with your Gmail address
  };
    ...
    <div className="relative">
      ...
      <div className="min-h-screen bg-blue-50 flex items-center justify-center relative" style={{ filter: 'saturate(120%)' }}>
        ...
        <div className="absolute inset-0 flex justify-center items-center">
          <div className="w-3/4 h-3/4 bg-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center p-5 max-w-6xl mx-auto z-10">
          <div className="flex-1 mb-5 md:mb-0 md:mr-10 text-center md:text-left">
            <h1 className="text-6xl md:text-8xl font-bold text-green-500 mb-4 animate-fade-in" style={{ filter: 'saturate(140%)' }}>
              Hey, I am Amit Kumar
            </h1>
            <p className="text-3xl md:text-4xl font-bold text-gray-600 mb-4 animate-fade-in">
              {titles[currentTitle]}
            </p>
            ...
            <a
              href="mailto:amitkgupta2308@gmail.com"
              className="text-xl font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-full px-6 py-3 transition duration-300 flex items-center"
              style={{ filter: 'saturate(190%)', textDecoration: 'none' }}
            >
              <Mail fontSize="small" className="mr-2" /> Reach Out to Me!
            </a>
          ...
          <div className="flex-1 relative">
            <div className="relative z-10">
              <Image 
                ...
                className="object-cover rounded-lg shadow-lg" // Add some style to the image
              />
            </div>
          </div>
        </div>
